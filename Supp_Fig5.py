...
custom_cmap = LinearSegmentedColormap.from_list("red_blue", ["darkblue", "lightblue"])
fig = plt.figure()
...
for i,file in enumerate(files):
    with open("data/datarun_rerun_tcc_processed/"+file,"r") as f:
        ...
        maxes += [[losses[0],tcc[np.nanargmax(rates)], np.nanmax(rates)]]
...
ax.view_init(30, -27) 
plt.show()
fig.savefig("FIG6.pdf",dpi=1000,bbox_inches="tight",transparent=True)
